...
.. topic:: Parameters
  ...
  *lxc_network_interface_manager:*
     ...
     using NetworkManager. Please note that you might need to enable nesting (:code:`security.nesting: "true"`)
     in order to get NetworkManager running properly in the lxc container.
  *create_default_user:*
